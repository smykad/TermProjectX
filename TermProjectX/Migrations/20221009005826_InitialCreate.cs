    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ObjectClassId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Containment = table.Column<string>(maxLength: 150, nullable: false),
                    ObjectClassID = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
